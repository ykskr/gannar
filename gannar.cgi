...
@items=(
	...
	{'name','鋼鉄柵','order',5,'gettype',0,'max',9,'need',2,},
	{'name','掘削機','order',6,'gettype',0,'max',9,'need',4,},
	{'name','土砂袋','order',7,'gettype',0,'max',9,'need',7,},
	{'name','芭蕉扇','order',4,'gettype',0,'max',9,},
	{'name','双眼鏡','order',8,'gettype',0,'max',9,'val',1,},
	{'name','帰還書','order',3,'gettype',0,'max',9,},
);
