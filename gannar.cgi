...
@items=(
	...
	{'name','栄養剤','order',3,'gettype',0,'max',9,'val',10,'fid',3,'time',3600,'ename','栄養剤NG',},
	{'name','鋼鉄柵','order',6,'gettype',0,'max',9,'need',2,},
	{'name','掘削機','order',7,'gettype',0,'max',9,'need',4,},
	{'name','土砂袋','order',8,'gettype',0,'max',9,'need',7,},
	{'name','芭蕉扇','order',5,'gettype',0,'max',9,},
	{'name','双眼鏡','order',9,'gettype',0,'max',9,'val',1,'val2',3,},
	{'name','帰還書','order',4,'gettype',0,'max',9,},
